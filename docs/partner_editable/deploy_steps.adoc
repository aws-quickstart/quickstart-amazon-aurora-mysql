...
//TODO Marcia to create the permalinks as soon as Dave confirms whether the file named "aurora_mysql-MASTER.template.yaml" is being renamed. 
//Marcia, I will rename the file
