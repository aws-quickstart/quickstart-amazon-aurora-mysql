...
//TODO Dave, Since this architecture has an optional Linux bastion host, should we change this location or omit the sentence?
//Marcia, I omitted the reference to the EC2 instance
